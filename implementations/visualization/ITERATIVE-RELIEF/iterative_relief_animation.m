function [rank, dist_weights] = iterative_relief_animation(data, target, m, min_incl, dist_func, max_iter, plot, axes, fgr, pauseBtnHandle, resetBtnHandle, timeout, use_deletions)
        ...
        while iter_count < max_iter && ~convergence
            ...
            for idx = idx_sampled
                ...
                if plot
                    ...
                    hT = title(axes, {'Iterative Relief Algorithm Visualization', sprintf('$$ weights = [%.3f, %.3f, %.3f] $$', dist_weights(1), dist_weights(2), dist_weights(3))},'interpreter','latex');
                    set(hT, 'FontSize', 17);
                end
                % ### /PLOTTING ###
                ...
                if plot
                    ...
                    [x, y, z] = sphere(128);
                    axis(axes, 'manual');
                    hypersph = surf(axes, min_r*x + e(1), min_r*y + e(2), min_r*z + e(3));
                    set(hypersph, 'FaceAlpha', 0.08);
                    shading(axes, 'interp');
                    light1 = light(axes, 'Position',[-1 2 0],'Style','local');
                ...
                if plot
                    ...
                    for same_nxt = data_same'
                        lines_same{line_ctr} = plot3(axes, [e(1), same_nxt(1)], [e(2), same_nxt(2)], [e(3), same_nxt(3)], 'g-', 'LineWidth', 2);
                    ...
                    for other_nxt = data_other'
                        lines_other{line_ctr} = plot3(axes, [e(1), other_nxt(1)], [e(2), other_nxt(2)], [e(3), other_nxt(3)], 'r-', 'LineWidth', 2);
