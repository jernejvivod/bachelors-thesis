...
%                          variable, character array, string array or cell
%                          array of strings; and S.prob containing a vector
%                          of corresponding probabilities. If the input
%                          value is 'empirical' (default), class 
%                          probabilities are determined from class 
%                          frequencies in Y. If the input value is 
%                          'uniform', all class probabilities are set equal.
