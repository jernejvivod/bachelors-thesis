function [] = linear_partitioning_visualization(tree_node, space_dims)
    ...
    if ~isstruct(tree_node)
        ...
        linear_partitioning_visualization(tree_node.l, space_dims_nxt1);
        
        % Compute bounds of region to be split recursively.
        space_dims_nxt2 = space_dims;
        space_dims_nxt2(tree_node.split_dim, 1) = tree_node.split_val;
        % Recursive call for right subtree.
        linear_partitioning_visualization(tree_node.r, space_dims_nxt2);
