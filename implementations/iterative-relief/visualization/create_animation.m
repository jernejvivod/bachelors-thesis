...
[weights, rank] = iterative_relief_animation(data3(:, 1:end-1), data3(:, end), size(data3, 1), min_incl,  @(a, b, w) minkowski_dist_weighted(a, b, w, 2), 100, 1, timeout, use_deletions);
