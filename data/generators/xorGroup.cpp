...
int main(int argc, char *argv[])
{
  ...
  for (i=0; i < NumberOfExamples ; i++)
  {
	  ...
	  } while (! (inCircle(A[1],A[2],0.25,0.25,0.2) || inCircle(A[1],A[2],0.25,0.75,0.2) 
		          || inCircle(A[1],A[2],0.75,0.25,0.2) || inCircle(A[1],A[2],0.75,0.75,0.2))) ;
	  A[0] = ((A[1]>0.5 && A[2]>0.5) || (A[1]<0.5 && A[2] <0.5) ?  1.0 : 0.0) ;
