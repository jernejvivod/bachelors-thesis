...
# Define RBAs to use.
rbas = {'VLSRelief_medissim' : VLSRelief(num_subsets=50, num_partitions_to_select=10, partition_size=5, k=K_PARAM, learned_metric_func=produce_learned_metric_func),
        'VLSRelief' : VLSRelief(num_subsets=50, num_partitions_to_select=10, partition_size=5, k=K_PARAM)
        }
