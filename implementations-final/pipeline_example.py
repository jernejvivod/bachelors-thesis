...
data = sio.loadmat('datasets/ovariancancer/data.mat')['data']
target = np.ravel(sio.loadmat('datasets/ovariancancer/target.mat')['target'])
...
param_grid_relief = {
    ...
    'relief__learned_metric_func' : [None, me_dissim_dist_func]
}

param_grid_relieff = {
    'relieff__n_features_to_select': np.arange(1, data.shape[1]+1),
    'relieff__dist_func': [manhattan, euclidean],
    'relieff__learned_metric_func' : [None, me_dissim_dist_func]
}
...
param_grid_iterative_relief = {
    ...
    'iterative_relief__learned_metric_func' : [None, me_dissim_dist_func]
}

param_grid_irelief = {
    'irelief__n_features_to_select': np.arange(1, data.shape[1]+1),
    'irelief__dist_func' : [manhattan_w_s, euclidean_w_s],
    'irelief__learned_metric_func' : [None, me_dissim_dist_func]
}
